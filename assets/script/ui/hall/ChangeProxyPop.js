...
export default class ChangeProxyPop extends cc.Component {
    ...
    onConfirm() {
        ...
        Connector.request(GameConfig.ServerEventName.ChangeProxyParent, { userID: parseInt(this.idInput.string), parentID: parseInt(this.proxyInput.string), clubID: App.Club.CurrentClubID }, (res) => {
            Cache.alertTip("调配成功")
        }, true, (err) => {
    ...
    onInputUser() {
        Cache.playSfx();
        Cache.showNumer('请输入调配合伙人ID',GameConfig.NumberType.INT, (userId) => {
